...
func (fq *FeatureQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (fq *FeatureQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (fq *FeatureQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (fq *FeatureQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (fq *FeatureQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (fq *FeatureQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := fq.IDs(ctx)
	if err != nil {
		panic(err)
	}
